...
var ResizeManager = /** @class */ (function () {
    ...
    ResizeManager.manageSocialButtons = function () {
        ...
        // if (Card.items != null)
        // {
        //     console.log("manage social buttons: " + Card.items.x)
        //     if (Card.items.x < 280)
        //     {
        ...
        //     document.getElementById("bannerrightsmall").style.visibility = "hidden"; 
        // }
        // if (document.getElementById("bannerleftsmall").dataset.turnedon != "true" )
        // {
        //     document.getElementById("bannerleftsmall").style.visibility = "hidden";
        // }
        // if (document.getElementById("bannerrightsmall").dataset.turnedon != "true" )
        // {
        //     document.getElementById("bannerrightsmall").style.visibility = "hidden";
        // }
    };
    ...
    ResizeManager.manageTxtCoordinates = function () {
        ...
        if (GameUI.timeTxt != null) {
            ...
            if (this.deviceWidth > 1000) {
                ...
                // document.getElementById("gplus").style.zIndex = "4";
                ...
                // document.getElementById("gplus").style.zIndex = "-1";
